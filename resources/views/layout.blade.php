...
<html lang="en">
    ...
    <body class="mb-48">
        <nav class="flex justify-between items-center mb-4">
            <a href="/"
                ><img class="w-24" src="{{asset('images/download.png')}}" alt="" class="logo"
            /></a>
...
<main>
    ...
    <p class="ml-2">Copyright &copy; 2023, All Rights reserved <br>&emsp;&emsp;&emsp; Developed And Managed By: Kapil Aryal</p>
